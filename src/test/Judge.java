...
public class Judge {
	...
	public boolean comparePlayerCard(Card[] cards, Player a, Player b, int n) {
	...
	public Level simpleJudgeLevelId(Card[] cards, int[] hand, int n) {
		if(n==1) {
	...
	public Level getJudgeLevel(Card[] cards, int[] hand) {
	...
	// 假设handcard已经从小数字到大数字进行了排列
	public boolean judgeFlush(Card[] cards, int[] hand) {
	...
	public boolean judgeStraight(Card[] cards, int[] hand) {
	...
	public int[] getSameCount(Card[] cards, int[] hand) {
	...
	public boolean simpleJudgeFlush(Card[] cards, int[] hand) {
		int colorCount[] = new int[4];
		for(int i=1;i<4;i++) {
			colorCount[cards[hand[i]].getColor()-1] += 1;
		}
	...
	public boolean simpleJudgeStraight(Card[] cards, int[] hand) {
